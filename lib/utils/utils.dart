...
class Utils {
  ...
  static String formatTime(String time) {
    ...
    final hour = int.parse(hourMinuteSecond[0]);
    final minute = hourMinuteSecond[1];
...
final monthName = Utils.getMonthName(dateTime.month);
    final hour = dateTime.hour; // Garde l'heure telle quelle
    return "${Utils.getTranslatedLabel(dueKey)}, ${dateTime.day} $monthName ${dateTime.year}, ${hour.toString().padLeft(2, '0')}:${dateTime.minute.toString().padLeft(2, '0')}";
  }
  ...
  static Future<void> showSnackBar({
    ...
    Get.snackbar(
      "",
      "",
      duration: errorMessageDisplayDuration,
