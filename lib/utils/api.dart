...
class Api {
  ...
  //
  static String getNotificationFromDatabase = "${databaseUrl}student/user-notification";
  ...
  static String getWeeklyAnnouncement = "${databaseUrl}student/get-weekly-announcement";

  static String changeTasksStatus = "${databaseUrl}teacher/check-task";
  static String deleteTasks = "${databaseUrl}teacher/delete-task";
  static String getTasks = "${databaseUrl}teacher/get-task";
  ...
  static String applyLeave = "${databaseUrl}leaves";
    static String addTasks = "${databaseUrl}teacher/task-add";
  static String getDadhboardTasks = "${databaseUrl}teacher/get-dashboard-task";
  static String updateTask = "${databaseUrl}teacher/task-edite";
  ...
  static String studentPunitions = "${databaseUrl}student/get-punition";
  static String studentAvertissement = "${databaseUrl}student/get-avertissement";
  ...
  static String getStudentAttendanceStatus = "${databaseUrl}parent/get-student-attendance";
  ...
  static String forgotPassword = "${databaseUrl}student/forgot-password-parent";
