...
class NotificationUtility {
  ...
  static String punitionType = "Punition";
  ...
  static void _onTapNotificationScreenNavigateCallback(
    ...
    } else if(type == punitionType){
      if (Get.currentRoute != Routes.punition) {
      //Get.toNamed(Routes.punition, arguments: {
      //    "childId": 12,
      //    "childFullName": data["ChildName"],
      //  },
      //);
      PunitionContainer(childId: data["ChildId"], childFullName: data["ChildName"]);
      }
    }
  }
