...
class ResultScreen extends StatelessWidget {
          ...
          return Row(
            ...
            children: [
              _buildResultTitleContainer(
                context: context,
                boxConstraints: boxConstraints,
                title: Utils.getTranslatedLabel(subjectKey),
              ),
              _buildResultTitleContainer(
                context: context,
                boxConstraints: boxConstraints,
  ...
  Widget _buildObtainedMarksContainer(BuildContext context) {
    return Container(
      ...
      width: MediaQuery.of(context).size.width * (0.85),
      child: Text(
        //"Moyenne générale  :  ${result.obtainedMark.toInt()}/${result.totalMark.toInt()}",
        "Moyenne générale  :  ${(result.obtainedMark.toInt() / result.subjectMarks.length).toStringAsFixed(2)}",
        style: TextStyle(
          color: redColor,
          fontSize: 15,
        ),
    ...
    return Column(
      ...
      children: [
        Text(
          title,
          style: TextStyle(
            color: textColor != null ? textColor : Theme.of(context).colorScheme.onSurface.withOpacity(0.75),
            fontWeight: FontWeight.w400,
            fontSize: 13.0,
          ),
            ...
            children: [
              Expanded(
                child: _buildPercentageAndGradeTitleAndValueContainer(
                  context: context,
                  title: "Points",
                  value: "${result.obtainedMark.toInt()}",
                ),
              ),
              Expanded(
                child: _buildPercentageAndGradeTitleAndValueContainer(
                  context: context,
                  title: "Rang",
                  textColor: result.grade == "1" ? greenColor : redColor,
          ...
          child: Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                color: result.grade == "1" ? greenColor : redColor,
                border: Border.all(
                  color: Theme.of(context).colorScheme.surface,
                  width: 8,
              ...
              child: Text(
                Utils.getTranslatedLabel(
                  ...
                  result.grade == "1" ? passedKey : failedKey,
                ),
                maxLines: 1,
      ...
      listener: (context, state) {
        if (state is DownloadStudentResultSuccess) {
          ...
          Utils.showCustomSnackBar(
              context: context,
              errorMessage: "Veuillez remplir les paramétres généraux de votre école",
