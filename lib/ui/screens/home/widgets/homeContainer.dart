...
import 'package:eschool/ui/screens/home/widgets/noteContainer.dart';
...
class _HomeContainerState extends State<HomeContainer> {
  ...
  Future<List<Weeklyannouncement>> getLeaveRequests() async {
    try {
      ...
      wekAnnLoading = false;
      // Récupérer les annonces et les assigner à la variable existante
      ...
      //print("les données de l'école sont ${school!.domain.toString()}");
  ...
  Widget _buildAdvertisemntSliders() {
    //
    final sliders = annonces;
    return WeeklySliderContainer(sliders: sliders);
  }
  ...
  Widget _buildSlidersSubjectsAndLatestNotcies() {
    return BlocConsumer<StudentSubjectsAndSlidersCubit,
      ...
      builder: (context, state) {
        ...
        return const HomeScreenDataLoadingContainer(
          addTopPadding: true,
        );
      },
    );
