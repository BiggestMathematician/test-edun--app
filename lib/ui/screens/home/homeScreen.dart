...
import 'package:eschool/ui/screens/avertissement/avertissementsContainer.dart';
import 'package:eschool/ui/screens/chatContacts/chatContactsScreenContainer.dart';
import 'package:eschool/ui/screens/graphique/graphiqueContainer.dart';
...
import 'package:eschool/ui/screens/punition/punitionsContainer.dart';
import 'package:eschool/ui/screens/reports/reportSubjectsContainer.dart';
import 'package:eschool/ui/screens/tasks/tasksContainer.dart';
...
class HomeScreenState extends State<HomeScreen>
  ...
  void updateBottomNavItems() {
    _bottomNavItems = context
        ...
        ? [
            ...
            BottomNavItem(
              activeImageUrl: Utils.getImagePath("chat_active_icon.svg"),
              disableImageUrl: Utils.getImagePath("chat_icon.svg"),
              title: "Chat",
            ),
            BottomNavItem(
  ...
  Widget _buildMenuItemContainer() {
    ...
    if (homeBottomSheetMenu[_currentlyOpenMenuIndex].title == "Mes tâches") {
      return const TasksContainer();
    }

    if (homeBottomSheetMenu[_currentlyOpenMenuIndex].title == "Mes punitions") {
      return const PunitionContainer();
    }

    if (homeBottomSheetMenu[_currentlyOpenMenuIndex].title == "Notes + graphique") {
      return const GraphiqueContainer();
    }

    if (homeBottomSheetMenu[_currentlyOpenMenuIndex].title == "Mes avertissements") {
      return const AvertissementContainer();
    }
  ...
  Widget _buildBottomSheetBackgroundContent() {
    ...
    if (_currentlyOpenMenuIndex != -1) {
      ...
      //Previous selected index is 1
      if (_previousSelectedBottmNavIndex == 2) {
        return ChatContactsScreenContainer(
          isForBottomMenuBackground: true,
        );
      }
