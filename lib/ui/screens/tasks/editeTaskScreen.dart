...
class EditeTaskscreen extends StatefulWidget {
  const EditeTaskscreen({super.key});
...
class _EditeTaskscreenState extends State<EditeTaskscreen> {
  ...
  void initState() {
    ...
    _durationEditingController.text = task.duration!;
    _selectedToDate = DateTime.parse(task.endDate!);
  }
          ...
          child: Container(
            ...
            child: CustomRoundedButton(
              ...
              onTap: () {
                ...
                context.read<ApplyLeaveCubit>().submitEditeTask(
