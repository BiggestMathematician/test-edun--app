...
class ChildDetailMenuScreenState extends State<ChildDetailMenuScreen> {
  ...
  void setMenuItems() {
    ...
    _menuItems = [
      ...
      MenuContainerDetails(
        moduleId: attendanceManagementModuleId.toString(),
        route: Routes.punition,
        arguments: {
          "childId": widget.student.userId,
          "childFullName": widget.student.getFullName(),
        },
        iconPath: Utils.getImagePath("punition.svg"),
        title: "Punitions",
      ),
      MenuContainerDetails(
        moduleId: attendanceManagementModuleId.toString(),
        route: Routes.avertissement,
        arguments: {
          "childId": widget.student.userId,
          "childFullName": widget.student.getFullName(),
        },
        iconPath: Utils.getImagePath("avertissement.svg"),
