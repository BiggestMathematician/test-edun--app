  ...
  Widget _buildAdvanceAmountContainer() {
    return Row(
      children: [
        ...
        const Spacer(),
        Text(
          "${_advanceAmount.toStringAsFixed(0)} ${getCurrencySymbol()}",
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      Text(
                        "${outstandingInstallmentsAmount.toStringAsFixed(0)} ${getCurrencySymbol()}",
                        style: getPaymentInfoAmountValueStyle(),
                      )
                    ],
                  ),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Spacer(),
                      Text(
                        "${currentInstallmentAmount.toStringAsFixed(0)} ${getCurrencySymbol()}",
                        style: getPaymentInfoAmountValueStyle(),
                      )
                    ],
                  ),
        ...
        widget.childFeeDetails.hasAnyDueInstallment()
            ? Row(
                children: [
                  ...
                  const Spacer(),
                  Text(
                    "${totalAmount.toStringAsFixed(0)} ${getCurrencySymbol()}",
                    style: getPaymentInfoAmountValueStyle(),
                  )
                ],
              )
      ...
      children: [
        Row(
          children: [
            ...
            const Spacer(),
            Text(
              "${feeAmount.toStringAsFixed(0)} ${getCurrencySymbol()}",
              style: getPaymentInfoAmountValueStyle(),
            )
          ],
        ),
        widget.childFeeDetails.isFeeOverDue()
            ? Row(
                children: [
                  ...
                  const Spacer(),
                  Text(
                    "${dueAmount.toStringAsFixed(0)} ${getCurrencySymbol()}",
                    style: getPaymentInfoAmountValueStyle()
                        .copyWith(color: Theme.of(context).colorScheme.error),
                  )
                ],
                ...
                return Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        "${(optionalFee.amount ?? 0).toStringAsFixed(0)} ${getCurrencySymbol()}",
                        style: TextStyle(
      ...
      children: [
                  ...
                  ?.map((compulsoryFee) => Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              "${(compulsoryFee.amount ?? 0).toStringAsFixed(0)} ${getCurrencySymbol()}",
                              style: TextStyle(
                                  color: Theme.of(context).colorScheme.primary),
                            ),
                          ],
            ...
            : widget.childFeeDetails.isFeeOverDue()
                ? Row(
                    ...
                    children: [
                      ...
                      const Spacer(),
                      Text(
                        "${widget.childFeeDetails.dueChargesAmount!.toStringAsFixed(0)} ${getCurrencySymbol()}",
                        style: TextStyle(
                            color: Theme.of(context).colorScheme.primary),
                      ),
                    ],
        ...
        Row(
          ...
          children: [
            ...
            const Spacer(),
            Text(
              "${widget.childFeeDetails.totalCompulsoryFees?.toStringAsFixed(0)} ${getCurrencySymbol()}",
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const Spacer(),
                      Text(
                        "${widget.childFeeDetails.remainingInstallmentAmount().toStringAsFixed(0)} ${getCurrencySymbol()}",
                        style: TextStyle(
                            fontWeight: FontWeight.w600,
                            color: Theme.of(context).colorScheme.primary),
                      ),
