            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          "${installmentAmount.toStringAsFixed(0)} ${getCurrencySymbol(context: context)}",
                          style: TextStyle(
                              fontWeight: isThisCurrentInstallment
                                  ? FontWeight.bold
                                  : null,
                ...
                (installment.isPaid ?? false)
                    ...
                    : installment.isInstallmentOverdue()
                        ? Text(
                            "Le montant dû est ${installment.dueCharges?.toStringAsFixed(0) ?? '-'}% du montant décidé du versement",
                            style: TextStyle(
                                fontSize: 12.0,
                                color: Theme.of(context)
                                    .colorScheme
                    ...
                    : Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Spacer(),
                            Text(
                              "${(totalAdvancePaidAmount).toStringAsFixed(0)} ${getCurrencySymbol(context: context)}",
                              style: TextStyle(
                                  fontSize: 13.0,
                                  color: Theme.of(context).colorScheme.primary),
                            )
