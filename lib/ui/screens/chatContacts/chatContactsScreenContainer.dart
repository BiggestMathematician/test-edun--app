...
class ChatContactsScreenContainer extends StatefulWidget {
  ChatContactsScreenContainer({
    Key? key,
    bool? isForBottomMenuBackground,
  }) : super(key: key);
  ...
  static Widget routeInstance() {
    ...
    return BlocProvider(
      ...
      child: ChatContactsScreenContainer(),
    );
  }
  ...
  @override
  State<ChatContactsScreenContainer> createState() =>
      _ChatContactsScreenContainerState();
}

class _ChatContactsScreenContainerState
    extends State<ChatContactsScreenContainer> {
