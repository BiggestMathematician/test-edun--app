...
class _AttendanceContainerState extends State<AttendanceContainer> {
  ...
  Widget _buildAttendanceCounterContainer({
    ...
    return Container(
      height: boxConstraints.maxWidth * (0.425),
      width: boxConstraints.maxWidth * (0.325),
  ...
  Widget _buildCalendarContainer({
    ...
    required List<AttendanceDay> lateDays,
  }) {
    return Container(
      ...
      child: TableCalendar(
        ...
        // Retard
        // Tu peux utiliser une autre couleur ou une autre décoration pour les jours de retard
        eventLoader: (date) {
          if (lateDays.any((element) =>
              Utils.formatDate(date) == Utils.formatDate(element.date))) {
            return ['Late']; // Retourne un objet pour identifier le retard
          }
          return [];
        },
        ...
        calendarStyle: CalendarStyle(
          ...
          markerDecoration: BoxDecoration(
            ...
            color: Color.fromARGB(255, 10, 9, 3),
          ),
            ...
            builder: (context, state) {
              if (state is AttendanceFetchSuccess) {
                ...
                List<AttendanceDay> presentDays = state.attendanceDays
                    ...
                    .toList();
                List<AttendanceDay> lateDays = state.attendanceDays
                          ...
                          return Row(
                            ...
                            children: [
                              ...
                              _buildAttendanceCounterContainer(
                                boxConstraints: boxConstraints,
                                title: "Total retadrs",
                                value: lateDays.length.toString(),
                                backgroundColor:
                                    Color.fromARGB(255, 10, 9, 3),
                              ),
                            ],
                          );
                        },
