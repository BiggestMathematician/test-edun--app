                  ...
                  children: [
                    SizedBox(
                        ...
                        child: Column(
                          children: [
                            CustomTextContainer(
                                textKey: (timeTableSlot.startTime).isEmpty
                                    ? "-"
                                    : Utils.formatTime(
                            ...
                            Container(
                              height: 50,
                              width: 1.5,
                              color: timeTableSlot.type == "Break"
                                  ? Colors.black
                                  : Color(int.parse(timeTableSlot
                                      .subject.bgColor!
                                      .replaceFirst('#', '0xFF'))),
                            ),
                            const Spacer(),
                            CustomTextContainer(
                                textKey: (timeTableSlot.endTime).isEmpty
                                    ? "-"
                                    : Utils.formatTime(timeTableSlot.endTime)),
                          ],
                        )),
                    SizedBox(
                      width: boxConstraints.maxWidth * (0.05),
                    ...
                    SizedBox(
                        ...
                        child: Container(
                            padding: timeTableSlot.note.isNotEmpty
                            ...
                            decoration: BoxDecoration(
                                ...
                                color:
                                    Theme.of(context).scaffoldBackgroundColor),
                            child: timeTableSlot.note.isNotEmpty
                                ? Center(
                                    child: Image.asset(
