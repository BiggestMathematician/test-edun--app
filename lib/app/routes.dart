...
import 'package:eschool/ui/screens/tasks/addTaskScreen.dart';
import 'package:eschool/ui/screens/tasks/editeTaskScreen.dart';
...
class Routes {
  ...
  static const String editTask = "/edit_task_screen";
  ...
  static const String punition = "/student/punition";
  static const String avertissement = "/parent/avertissement";
  ...
  static List<GetPage> getPages = [
    ...
    GetPage(name: addTask, page: () => Addtaskscreen.routeInstance()),
    GetPage(name: editTask, page: () => EditeTaskscreen.routeInstance()),
    ...
    GetPage(
        name: taskPage, page: () => TasksContainer.routeInstance()),
    GetPage(
    ...
    GetPage(name: punition, page: () => PunitionContainer.routeInstance()),
    GetPage(name: avertissement, page: () => AvertissementContainer.routeInstance()),
    GetPage(
