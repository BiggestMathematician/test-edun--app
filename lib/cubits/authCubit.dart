...
class Authenticated extends AuthState {
  ...
  final MainSchoolModel mainSchool;
...
class AuthCubit extends Cubit<AuthState> {
    ...
    if (authRepository.getIsLogIn()) {
      emit(
        Authenticated(
          ...
          mainSchool: AuthRepository.getSchoolDetails(),
  ...
  void authenticateUser({
    ...
    required MainSchoolModel mainSchool,
    ...
    authRepository.setSchoolDetails(mainSchool);
  ...
  MainSchoolModel getSchoolDetails() {
    if (state is Authenticated) {
      return (state as Authenticated).mainSchool;
    }
